...
const DocumentPage = () => {
    ...
    return (
        <div className="document-page">
            <h2 className='ClaimHeading'>NASH-WERTHAN ART COLLECTION & PRODUCT COLLABORATION</h2>
            <div className='describe'>
                ...
                <h4>CLAIM FORM:</h4>
                <p>To receive the Physical Product, you are required to fill out a form, provide us with your mailing address, and pay for the shipping and handling, as well as any other optional upgrades of your choice associated with sending the product or storing your product, either physically or digitally, for later production. </p>
                <form onSubmit={handleSubmit}>
                    <label>
                        ...
                        />
                        <span className='condationsType'>CONDITIONAL ACCEPTANCE AGREEMENT:</span> By clicking this box, you acknowledge that you have read the disclaimer and the conditional acceptance agreement in the non-fungible and fungible token smart contracts (The “Agreement”).
                    </label>
                    <br />
                    <label>
                        <input
